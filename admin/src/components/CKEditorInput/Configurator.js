...
const CKEDITOR_BASE_CONFIG_FOR_PRESETS = {
  light: {
    ...
    heading: {
      options: [
        {model: 'paragraph', view: {name: 'p', classes: "text-current"}, title: 'Paragraph', class: 'ck-heading_paragraph'},
        {model: 'heading1', view: {name: 'h3', classes: "text-4xl"}, title: 'Heading 1', class: 'ck-heading_heading1'},
        {model: 'heading2', view: {name: 'h4', classes: "text-3xl"}, title: 'Heading 2', class: 'ck-heading_heading2'},
        {model: 'heading3', view: {name: 'h5', classes: "text-2xl"}, title: 'Heading 3', class: 'ck-heading_heading3'},
        {model: 'heading4', view: {name: 'h6', classes: "text-xl"}, title: 'Heading 4', class: 'ck-heading_heading4'},
      ]
    },
    image: {
      toolbar: [
